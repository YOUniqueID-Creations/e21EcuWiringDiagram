...
def get_fuse_box(x=0, y=0):
    ...
    return elm.Ic(
        pins=[
            elm.IcPin(name='12V IN', pin='IN', side='bottom'),
            elm.IcPin(name='Fuse 6 (Aux)', pin='F6', side='left'),
            ...
            elm.IcPin(name='Fuse 2 (MAF)', pin='F2', side='left'),
            elm.IcPin(name='Fuse 1 (ECU)', pin='F1', side='left'),
        ],
